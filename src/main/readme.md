...
содержимое возьмем издокументации —принга или из гитхаба автора видео  ;)
короче, в теге <bean> мы указываем id="им€ бина" и class="полное им€ класса"
...
теперьмы можем решать, какую используем имплементацию, без какого-либо вмешательства в наш код, вставл€€ id нужного бина в тег конструктора клиента.

Ќо! еще надо прочитать этот xml и получить доступ к бинам.
...
»! мы можем ужесейчас использовать этот готовый объект
